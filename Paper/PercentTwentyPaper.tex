...
Our agent uses a combination of heuristics and counterfactual regret minimization to make decisions when drawing, discarding, knocking, and melding cards.
